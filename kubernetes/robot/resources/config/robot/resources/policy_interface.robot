...
Reboot Drools
    ...
    Wait Until Keyword Succeeds    120    5 sec    Open Connection And Log In    ${GLOBAL_INJECTED_RANCHER_IP}    ubuntu    ${GLOBAL_ONAP_PRIVATE_KEY}
    Write    ${sudo}
    ${status}   ${stdout}=	 Run Keyword And Ignore Error    SSHLibrary.Read Until Regexp    ubuntu#
    Write    ${stop}
