...
{{ include "common.genericService" (dict "postfix" $postfix "annotations" $annotations "dot" . 
                                         "publishNotReadyAddresses" $publishNotReadyAddresses
                                         "ports" $ports "portType" $portType) }}
{{- end -}}
...
{{ include "common.genericService" (dict "postfix" $postfix "annotations" $annotations "dot" . 
                                         "publishNotReadyAddresses" $publishNotReadyAddresses
                                         "ports" $ports "portType" "ClusterIP" "headless" true ) }}
{{- end -}}
