...
{{- $dbrootsecret := include "common.mariadb.secret.rootPassSecretName" (dict "dot" . "chartName" "") -}}
{{- $dbusersecret := include "common.mariadb.secret.userCredentialsSecretName" (dict "dot" . "chartName" "") -}}
---
apiVersion: mariadb.mmontes.io/v1alpha1
kind: MariaDB
metadata:
