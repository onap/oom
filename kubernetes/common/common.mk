...
VERSION := $(shell cat '$(CURDIR)/Chart.yaml' | yq -r '.version')
...
.PHONY:  $(SUM_DIR)/$(PACKAGE_NAME).sum $(SUM_DIR)/$(PACKAGE_NAME).sum.filtered
...
$(PACKAGE_NAME): % :$(SUM_DIR)/%.sum.filtered
	@echo "\n[$@]"
