...
{"service": {"name": "mso-jra-healthcheck",
  "check": {"script": "curl http://mso.onap-mso.svc.cluster.local:8080/networks/rest/healthcheck 2>&1 | grep 'Application ready' | wc -l| grep 1", "interval": "10s"}}}
