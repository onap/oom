...
{{/*
  ...
  # ConfigMap Configuration for Feed, Dr_Publisher, Dr_Subscriber
  volumes:
    - name: feeds-config
...
{{- $drSubConfig := default $dot.Values.drSubConfig .drSubConfig -}}
{{- if or $drFeedConfig $drPubConfig $drSubConfig -}}
