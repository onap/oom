...
RC1={{ .Values.global.sdc_cassandra.rc1 }}
RC3={{ .Values.global.sdc_cassandra.replicaCount }}
...
KEYSPACE="CREATE KEYSPACE IF NOT EXISTS dox WITH REPLICATION = { 'class' : 'NetworkTopologyStrategy', '$DC_NAME': '$RC1'};"
KEYSPACE1="CREATE KEYSPACE IF NOT EXISTS zusammen_dox WITH REPLICATION = { 'class' : 'NetworkTopologyStrategy', '$DC_NAME': '$RC1'};"
KEYSPACE2="CREATE KEYSPACE IF NOT EXISTS sdctitan WITH REPLICATION = { 'class' : 'NetworkTopologyStrategy', '$DC_NAME': '$RC3'} AND durable_writes = true;"
