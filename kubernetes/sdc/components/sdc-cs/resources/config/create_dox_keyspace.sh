...
KEYSPACE2="CREATE KEYSPACE IF NOT EXISTS sdctitan WITH REPLICATION = { 'class' : 'NetworkTopologyStrategy', '$DC_NAME': '{{ .Values.global.sdc_cassandra.replicaCount }}'} AND durable_writes = true;"
