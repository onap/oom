...
GLOBAL_MSB_SERVER_PORT = '{{include "robot.ingress.port" (dict "root" . "hostname" "msb-iag" "port" ( ternary 443 80 (eq "true" (include "common.needTLS" . )))) }}''{{include "robot.ingress.port" (dict "root" . "hostname" "clamp" "port" 443) }}'
