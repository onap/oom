...
# heat template parameter values common to all heat template continaing these parameters
     "defaults" : {
        ...
        "{{ .Values.nsPrefix }}_private_net_id" : "{{ .Values.openStackPrivateNetId }}",
        "{{ .Values.nsPrefix }}_private_subnet_id" : "{{ .Values.openStackPrivateSubnetId }}",
        "{{ .Values.nsPrefix }}_private_net_cidr" : "{{ .Values.openStackPrivateNetCidr }}",
