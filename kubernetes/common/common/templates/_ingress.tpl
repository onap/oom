...
{{- if .Values.ingress -}}
{{- if .Values.global.ingress -}}
{{- $temporary := set . "ingressEnableFlag" (default .Values.global.ingress.enabled .Values.ingress.enabled) -}}
{{- else -}}
{{- $temporary := set . "ingressEnableFlag" (default .Values.ingress.enabled false) -}}
{{- end -}}
