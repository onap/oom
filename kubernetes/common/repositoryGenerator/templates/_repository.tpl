...
{{- define "repositoryGenerator.repository" -}}
  ...
  {{- else -}}
    {{- default $initRoot.common.repository $dot.Values.global.repository -}}
  {{- end }}
{{- end -}}
...
{{- define "repositoryGenerator.dockerHubRepository" -}}
  ...
  {{- else }}
    {{- default $initRoot.common.dockerHubRepository $dot.Values.global.dockerHubRepository -}}
  {{- end }}
{{- end -}}
...
{{- define "repositoryGenerator.elasticRepository" -}}
  ...
  {{- else }}
    {{- default $initRoot.common.elasticRepository $dot.Values.global.elasticRepository -}}
  {{- end }}
{{- end -}}
...
{{- define "repositoryGenerator.googleK8sRepository" -}}
  ...
  {{- else }}
    {{- default $initRoot.common.googleK8sRepository $dot.Values.global.googleK8sRepository -}}
  {{- end }}
{{- end -}}
...
{{- define "repositoryGenerator.image.busybox" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.busyboxImage $dot.Values.global.busyboxImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.curl" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.curlImage $dot.Values.global.curlImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.envsubst" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.envsubstImage $dot.Values.global.envsubstImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.htpasswd" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.htpasswdImage $dot.Values.global.htpasswdImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.kubectl" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.kubectlImage $dot.Values.global.kubectlImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.logging" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.elasticRepository" $dot }}/{{- default $initRoot.common.loggingImage $dot.Values.global.loggingImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.mariadb" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.mariadbImage $dot.Values.global.mariadbImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.nginx" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.nginxImage $dot.Values.global.nginxImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.postgres" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.dockerHubRepository" $dot }}/{{- default $initRoot.common.postgresImage $dot.Values.global.postgresImage -}}
{{- end -}}

{{- define "repositoryGenerator.image.readiness" -}}
  {{- $dot := default . .dot -}}
  {{- $initRoot := default $dot.Values.repositoryGenerator .initRoot -}}
  {{- include "repositoryGenerator.repository" $dot }}/{{- default $initRoot.common.readinessImage $dot.Values.global.readinessImage -}}
{{- end -}}
