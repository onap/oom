...
{{- define "common.mariadbGrant" -}}
{{- $dot := default . .dot -}}
{{- $dbgrant := (required "'dbgrant' param, is required." .dbgrant) -}}
{{- $dbuser := (required "'dbuser' param, is required." .dbuser) -}}
{{- $dbinst := (required "'dbinst' param, is required." .dbinst) -}}
---
apiVersion: mariadb.mmontes.io/v1alpha1
...
spec:
  ...
  inheritMetadata:
    ...
    labels:
      ...
      app.kubernetes.io/name: {{ include "common.mariadbService" . }}
...
#### Dont need below
{{-  if .Values.db.grant }}
{{ include "common.mariadbGrant" (dict "dot" . "dbuser" .Values.db.user "dbinst" $dbinst "dbgrant" .Values.db.grant) }}
{{-  end }}
{{ end }}
{{- end -}}
