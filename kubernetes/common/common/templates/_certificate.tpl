...
{{- $name           := default $dot.Values.global.certificate.default.name            $certificate.name           -}}
{{- $namespace      := default $dot.Values.global.certificate.default.namespace       $certificate.namespace      -}}
{{- $secretName     := default $dot.Values.global.certificate.default.secretName      $certificate.secretName     -}}
