...
{{- end -}}
{{/*# Keystores #*/}}
{{- $createJksKeystore                  := $subchartGlobal.certificate.default.jksKeystore.create                  -}}
{{- $jksKeystorePasswordSecretName      := $subchartGlobal.certificate.default.jksKeystore.passwordSecretRef.name  -}}
{{- $jksKeystorePasswordSecreKey        := $subchartGlobal.certificate.default.jksKeystore.passwordSecretRef.key   -}}
{{- $createP12Keystore                  := $subchartGlobal.certificate.default.p12Keystore.create                  -}}
{{- $p12KeystorePasswordSecretName      := $subchartGlobal.certificate.default.p12Keystore.passwordSecretRef.name  -}}
{{- $p12KeystorePasswordSecreKey        := $subchartGlobal.certificate.default.p12Keystore.passwordSecretRef.key   -}}
