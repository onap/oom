...
*/}}
{{- define "common.persistenceRoot" -}}
{{ .Values.global.persistence.mountPath | default .Values.persistence.mountPath }}
{{- end -}}
...
spec:
  ...
  hostPath:
    path: {{ include "common.persistenceRoot" . }}/{{ include "common.release" . }}/{{ .Values.persistence.mountSubPath }}
{{- end -}}
{{- end -}}
{{- end -}}
...
spec:
  ...
  hostPath:
    path: {{ include "common.persistenceRoot" $global }}/{{ include "common.release" $global }}/{{ $global.Values.persistence.mountSubPath }}-{{$i}}
{{- end -}}
{{- end -}}
{{- end -}}
{{- end -}}
