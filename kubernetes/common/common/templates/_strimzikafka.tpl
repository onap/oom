...
{{/*
  ...
  Strimzi kafka provides cluster access via it's custom resource definition KafkaUser
  which is deployed using it's User Operator component.
  See more infor here - https://github.com/strimzi/strimzi-kafka-operator/blob/main/helm-charts/helm3/strimzi-kafka-operator/crds/044-Crd-kafkauser.yaml
...
{{/*
  ...
  Strimzi kafka provides kafka topic management via it's custom resource definition KafkaTopic
  which is deployed using it's Topic Operator component.
  ...
  Note: KafkaTopic names shoudl adhere to kubernetes object naming conventions - https://kubernetes.io/docs/concepts/overview/working-with-objects/names/
