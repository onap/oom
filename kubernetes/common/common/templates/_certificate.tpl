...
#
# To request a certificate just create an object 'certificates' in the values.yaml file in your component
# and invoke the function "commom.certificate" in the file templates/certificates.yaml.
#
# Here is an example of the certificate definition (to be placed in the file values.yaml):
...
# Other mandatory fields for the certificate definitions do not have to be defined directly,
# in that case they wiil  be taken from default values.
#
# Default values are defined in file onap/values.yaml (see-> certificate.default)
