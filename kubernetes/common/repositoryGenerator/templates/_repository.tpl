...
{{/*
  ...
  - .Values.global.mariadbContainerRepository  : default image mariadbContainerRepository for all images using mariadb repository
  - .Values.mariadbContainerRepositoryOverride : override global mariadbContainerRepository repository on a per chart basis
*/}}
{{- define "repositoryGenerator.mariadbContainerRepository" -}}
  {{- include "repositoryGenerator._repositoryHelper" (merge (dict "repoName" "mariadbContainerRepository") .) }}
{{- end -}}
