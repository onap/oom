...
the nodes as in the example below (11.0.0.4 is private to the K8s cluster only).
...
corresponds to the private IP as follows::
  ...
  portal-app  LoadBalancer   10.43.142.201   11.0.0.4   8989:30215/TCP,8006:30213/TCP,8010:30214/TCP   1d   app=portal-app,release=dev
...
To fetch release history enter::
  ...
  2        Mon Feb 5 10:10:55 2020  DEPLOYED   so-11.0.0 Upgrade complete
...
For example, to roll-back back to previous system revision enter::
  ...
  REVISION UPDATED                  STATUS     CHART     DESCRIPTION
  1        Mon Feb 5 10:05:22 2020  SUPERSEDED so-9.0.0  Install complete
  2        Mon Feb 5 10:10:55 2020  SUPERSEDED so-11.0.0 Upgrade complete
