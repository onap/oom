...
{{-   $burl := include "common.ingress._overrideIfDefined" (dict "currVal" $burl "parent" (default (dict) .Values.ingress) "var" "baseurlOverride") }}
...
{{-   $dot := default . .dot -}}
{{-   if $dot.ingress -}}
{{-     if $dot.global.ingress -}}
{{-       if (default false .Values.global.ingress.enabled) -}}
{{-         if (default false .Values.global.ingress.enable_all) -}}
true
{{-         else -}}
{{-           if $dot.ingress.enabled -}}
true
{{-           end -}}
{{-         end -}}
{{-       end -}}
