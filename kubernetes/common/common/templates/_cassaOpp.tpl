  ...
  cassandra:
    ...
    datacenters:
      - metadata:
        ...
        stargate:
          size: {{ .Values.K8SCluster.datacenters.stargate.size }} #Component 11 #Component
          heapSize:
           {{ .Values.K8SCluster.datacenters.stargate.heapSize }} #Component 11 #Component #Component
{{ end }}          
