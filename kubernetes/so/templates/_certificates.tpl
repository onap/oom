{{- define "certificate.container_importer" -}}
...
{{- define "certificate.volume-mounts" -}}
- name: {{ include "common.name" . }}-certificates
...
{{- define "certificate.volumes" -}}
- name: {{ include "common.name" . }}-certificates
  emptyDir:
    medium: Memory
- name: {{ include "common.name" . }}-onap-certificates
  secret:
    secretName: {{ include "common.secret.getSecretName" (dict "global" . "uid" "onap-certs") }}
{{- end -}}
