<<<<<<< b6f89dc0d2b461a7e3f083ebe8936de2bb8e0f6e:kubernetes/policy/charts/drools/resources/scripts/update-vfw-op-policy.sh
# Copyright © 2017 Amdocs, Bell Canada, AT&T
=======
# Copyright © 2017 Amdocs, Bell Canada
>>>>>>> Apache 2 license addition for all configuration:kubernetes/policy/scripts/update-vfw-op-policy.sh
#
