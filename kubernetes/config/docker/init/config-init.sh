...
SED_CONFIG_STRINGS=( \
  ...
  "s/VNF_OPENSTACK_OAM_NETWORK_ID_HERE/${VNF_OPENSTACK_OAM_NETWORK_ID}/g" \
  "s/VNF_OPENSTACK_PUBLIC_ID_HERE/${VNF_OPENSTACK_PUBLIC_ID}/g" \
  "s/VNF_OPENSTACK_FLAVOR/${VNF_OPENSTACK_FLAVOR}/g" \
  "s/VNF_OPENSTACK_IMAGE/${VNF_OPENSTACK_IMAGE}/g" \
)
...
if [ "$DEPLOY_DCAE" = "true" ]
then
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DCAE_IP_ADDR_HERE/$DCAE_IP_ADDR/g" {} \;

    ########
    # DCAE #
    ########
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DCAE_VM_BASE_NAME_HERE/$DCAE_VM_BASE_NAME/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DCAE_DOCKER_VERSION_HERE,$DCAE_DOCKER_VERSION,g" {} \;
    ...
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DCAE_OS_PUBLIC_NET_ID_HERE,$DCAE_OS_PUBLIC_NET_ID,g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DCAE_OS_PUBLIC_NET_NAME_HERE,$DCAE_OS_PUBLIC_NET_NAME,g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DCAE_OS_OAM_NETWORK_CIDR_HERE,$DCAE_OS_OAM_NETWORK_CIDR,g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DCAE_IP_ADDR_HERE,$DCAE_IP_ADDR,g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DCAE_DOMAIN_HERE,$DCAE_DOMAIN,g" {} \;

    ###########
    # Flavors #
    ###########
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/OPENSTACK_FLAVOR_SMALL_HERE/$DCAE_OS_FLAVOR_SMALL/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/OPENSTACK_FLAVOR_MEDIUM_HERE/$DCAE_OS_FLAVOR_MEDIUM/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/OPENSTACK_FLAVOR_LARGE_HERE/$DCAE_OS_FLAVOR_LARGE/g" {} \;

    ##########
    # Images #
    ##########
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/UBUNTU_14_IMAGE_NAME_HERE/$DCAE_OS_UBUNTU_14_IMAGE/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/UBUNTU_16_IMAGE_NAME_HERE/$DCAE_OS_UBUNTU_16_IMAGE/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/OPENSTACK_CENTOS_7_IMAGE_HERE/$DCAE_OS_CENTOS_7_IMAGE/g" {} \;


    ###########
    # KeyPair #
    ###########
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/OPENSTACK_KEY_NAME_HERE/$DCAE_OS_KEY_NAME/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,OPENSTACK_PUB_KEY_HERE,$DCAE_OS_PUB_KEY,g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,OPENSTACK_PRIVATE_KEY_HERE,$DCAE_OS_PRIVATE_KEY,g" {} \;

    #######
    # DNS #
    #######
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNS_LIST_HERE/$DNS_LIST/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/EXTERNAL_DNS_HERE/$EXTERNAL_DNS/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNS_FORWARDER_HERE/$DNS_FORWARDER/g" {} \;
    ...
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNSAAS_API_VERSION_HERE/$DNSAAS_API_VERSION/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNSAAS_REGION_HERE/$DNSAAS_REGION/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s,DNSAAS_KEYSTONE_URL_HERE,$DNSAAS_KEYSTONE_URL,g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNSAAS_TENANT_NAME_HERE/$DNSAAS_TENANT_NAME/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNSAAS_TENANT_ID_HERE/$DNSAAS_TENANT_ID/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNSAAS_USERNAME_HERE/$DNSAAS_USERNAME/g" {} \;
    find /config-init/$NAMESPACE/dcaegen2/heat/ -type f -exec sed -i -e "s/DNSAAS_PASSWORD_HERE/$DNSAAS_PASSWORD/g" {} \;
