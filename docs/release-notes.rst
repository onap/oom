...
- `OOM-2279 <https://jira.onap.org/browse/OOM-2279>`_ oom elalto and master
...
"compiled" into helm package. see step 6 in :doc:
`quickstart guide <oom_quickstart_guide>`.
...
- :doc: `Hard coded sertificates <oom_hardcoded_certificates>` in helm packages
